/**
 * Programmes Layout — provides metadata for the /en/corporate/programmes page.
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/en/corporate/programmes`,
    languages: languageAlternates("/corporate/programmes"),
  },
  openGraph: {
    ...OG_DEFAULTS,
    locale: "en_MA",
    ...
    url: `${SITE_URL}/en/corporate/programmes`,
  },
  twitter: {
    ...TWITTER_DEFAULTS,
    title: "Certified Corporate Wellness Programs | Wenaya",
