...
/** English homepage SEO metadata — title, description, canonical, Open Graph, Twitter */
export const metadata: Metadata = {
  title: "Wenaya — Integrated Health & Wellbeing | Casablanca, Morocco",
  description:
    "Wenaya is Morocco's first integrated health platform. Physiotherapy, clinical psychology, nutrition and corporate wellness — from Casablanca. Rated 4.7/5 on Google Maps.",
  alternates: {
...
const homepageJsonLd = {
  ...
  "@type": "WebPage",
  url: ENGLISH_HOME_URL,
  name: "Wenaya — Integrated Health & Wellbeing | Casablanca, Morocco",
  description:
    "Morocco's first integrated health and wellbeing platform. Physiotherapy, clinical psychology, nutrition, and corporate wellness — from Casablanca.",
  inLanguage: "en",
