/**
 * ConfiguratorComingSoon — premium editorial "health configurator coming soon"
 * page shown on /configurateur and /en/configurator while the configurator
...
export default function ConfiguratorComingSoon({ locale }: ConfiguratorComingSoonProps) {
