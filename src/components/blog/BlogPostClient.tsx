        ...
        <div className="relative max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-white/40 text-xs font-mono">{post.readingTime} {t("blog.minLecture")}</span>
            </div>
            ...
            {post.author && (
              ...
              >
                ...
                <span className="text-white/30 text-xs font-mono ml-auto">{formatDate(post.publishedAt, locale)}</span>
              </motion.div>
            )}
          </motion.div>
        </div>
            ...
            <div className="lg:hidden flex items-center gap-3 mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  {copied ? t("blog.copie") : <span className="hidden sm:inline">{t("blog.copier")}</span>}
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {related.map((r) => (
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="text-xs text-gray-400 font-mono mb-2">{formatDate(r.publishedAt, locale)} · {r.readingTime} min</div>
