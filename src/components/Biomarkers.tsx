    ...
    <section ref={sectionRef} className="bg-[#F2EFE9] py-12 sm:py-28 px-6" id="univers">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bio-cell text-center mb-8 sm:mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-[#2B2F36]/50 text-[13px] sm:text-[14px] lg:text-[15px] leading-relaxed max-w-md mx-auto mt-4">
            <SubtitleSplit text={content?.sub ?? t("biomarkers.sub")} bronze={locale === "fr" ? "et définir vos priorités." : "and define your priorities."} />
          </p>
        </div>
          ...
          {pillars.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="relative text-[#B88A5A] text-[11px] font-semibold tracking-[0.22em] uppercase">
                  {p.subheader}
                </span>
