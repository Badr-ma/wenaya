...
export default function ConditionsPage() {
  ...
  const sections = tRaw<string[]>("conditions.sections") || [];
  const content = tRaw<Record<string, string>>("conditions.content") || {};
  const lastUpdate = t("conditions.lastUpdate");
      ...
      <div className="flex-1 bg-[#F2EFE9] pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2.5 mb-8">
            ...
            <span className="text-[#B88A5A] text-[11px] font-semibold tracking-[0.22em] uppercase">{t("conditions.badge")}</span>
          </div>
