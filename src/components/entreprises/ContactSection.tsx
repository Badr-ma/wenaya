    ...
    <div>
      ...
      <div className="relative">
        ...
        >
          ...
          {options.map((opt) => (
            <option key={opt.value} value={opt.value} className="text-[#0B1220]">
              {opt.label}
            </option>
          ))}
        </select>
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="ct-head">
            ...
            <h2 className="heading-serif text-[#0B1220] mt-5 leading-[1.06]" style={{ fontSize: "clamp(1.8rem, 2.9vw, 2.35rem)" }}>
              {t("entreprises.contactSection.heading")}
            </h2>
            <p className="text-[#2B2F36]/60 text-base leading-relaxed mt-4 max-w-md">
            ...
            <ul className="mt-9 space-y-5">
              <li className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[#0B1220]/40 text-[11px] font-semibold uppercase tracking-[0.12em]">{t("entreprises.contactSection.emailLabel")}</p>
                  <a href="mailto:corporate@wenaya.com" className="text-[#0B1220] text-sm font-medium transition-colors hover:text-[#B88A5A]">
              ...
              <li className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[#0B1220]/40 text-[11px] font-semibold uppercase tracking-[0.12em]">{t("entreprises.contactSection.phoneLabel")}</p>
                  <a href="tel:+212666124035" className="text-[#0B1220] text-sm font-medium transition-colors hover:text-[#B88A5A]">
              ...
              <li className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[#0B1220]/40 text-[11px] font-semibold uppercase tracking-[0.12em]">{t("entreprises.contactSection.addressLabel")}</p>
                  <p className="text-[#0B1220] text-sm font-medium">{t("entreprises.contactSection.address")}</p>
                </div>
              </li>
            </ul>
            ...
            <div className="mt-10">
              <a
                ...
                className="group inline-flex items-center justify-center gap-2.5 h-13 px-8 rounded-lg text-white text-base font-semibold bg-[#0B1220] transition-all duration-300 hover:bg-[#B88A5A] active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#B88A5A]"
              >
              ...
              <p className="text-[#0B1220]/40 text-xs mt-5 tracking-[0.05em]">
