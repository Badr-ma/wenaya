  ...
  return (
    <section ref={sectionRef} className="relative bg-[#0B1220] py-24 sm:py-36 px-6 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-[#B88A5A]/[0.03] blur-3xl" />
      ...
      <div className="max-w-5xl mx-auto relative">
        <div className="grid sm:grid-cols-12 gap-10 sm:gap-16 items-start">
          <div className="ct-head sm:col-span-5">
            ...
            <h2 className="heading-serif text-white text-[clamp(2rem, 4vw, 3.5rem)] mt-5 leading-[1.06]">
            ...
            <div className="mt-10 space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-white/35 text-[10px] font-semibold tracking-[0.1em] uppercase">Email</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-white/35 text-[10px] font-semibold tracking-[0.1em] uppercase">Response time</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#F2EFE9]/50 border border-[#0B1220]/[0.06] rounded-xl px-4 py-3 text-[#0B1220] text-sm placeholder:text-[#2B2F36]/[0.25] outline-none focus:border-[#B88A5A]/30 focus:bg-[#F2EFE9]/80 transition-all duration-200"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#F2EFE9]/50 border border-[#0B1220]/[0.06] rounded-xl px-4 py-3 text-[#0B1220] text-sm placeholder:text-[#2B2F36]/[0.25] outline-none focus:border-[#B88A5A]/30 focus:bg-[#F2EFE9]/80 transition-all duration-200 resize-none"
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="group inline-flex items-center gap-3 bg-[#0B1220] text-white px-8 py-3.5 rounded-full text-sm font-semibold tracking-wide hover:bg-[#B88A5A] transition-colors duration-300 w-full sm:w-auto justify-center"
                  >
